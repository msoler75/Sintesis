...
export default class SintesisParser extends antlr4.Parser {
	...
	assignable() {
	    ...
	    this.enterRule(localctx, 70, SintesisParser.RULE_assignable);
	    var _la = 0; // Token type
	    try {
	        this.state = 527;
	        this._errHandler.sync(this);
	...
	reservedWord() {
	    ...
	    this.enterRule(localctx, 72, SintesisParser.RULE_reservedWord);
	    try {
	        this.state = 532;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	literal() {
	    ...
	    this.enterRule(localctx, 74, SintesisParser.RULE_literal);
	    try {
	        this.state = 539;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	booleanLiteral() {
	    ...
	    this.enterRule(localctx, 76, SintesisParser.RULE_booleanLiteral);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 541;
	        this.match(SintesisParser.BooleanLiteral);
	...
	stringLiteral() {
	    ...
	    this.enterRule(localctx, 78, SintesisParser.RULE_stringLiteral);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 543;
	...
	nullLiteral() {
	    ...
	    this.enterRule(localctx, 80, SintesisParser.RULE_nullLiteral);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 545;
	        this.match(SintesisParser.NullLiteral);
	...
	numericLiteral() {
	    ...
	    this.enterRule(localctx, 82, SintesisParser.RULE_numericLiteral);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 547;
	...
	identifierName() {
	    ...
	    this.enterRule(localctx, 84, SintesisParser.RULE_identifierName);
	    try {
	        this.state = 551;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	keyword() {
	    ...
	    this.enterRule(localctx, 86, SintesisParser.RULE_keyword);
	    try {
	        this.state = 563;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
...
SintesisParser.RULE_assignable = 35;
SintesisParser.RULE_reservedWord = 36;
SintesisParser.RULE_literal = 37;
SintesisParser.RULE_booleanLiteral = 38;
SintesisParser.RULE_stringLiteral = 39;
SintesisParser.RULE_nullLiteral = 40;
SintesisParser.RULE_numericLiteral = 41;
SintesisParser.RULE_identifierName = 42;
SintesisParser.RULE_keyword = 43;
