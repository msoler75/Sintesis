...
export default class SintesisParser extends antlr4.Parser {
    ...
    static ruleNames = [ "program", "statementList", "statement", "block", 
                         ...
                         "classExp", "vectorIndex", "vectorIndexes", "vectorLiteral", 
	...
	varDeclaration() {
	    ...
	    try {
	        ...
	        case 2:
	            localctx = new MapDeclarationContext(this, localctx);
	            this.enterOuterAlt(localctx, 2);
	            this.state = 386;
	            this.match(SintesisParser.Var);
	            this.state = 387;
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if(_la===SintesisParser.Map) {
	                this.state = 389;
	                this.match(SintesisParser.Map);
	            }

	            this.state = 392;
	            localctx.arg = this.arguments();
	            break;
	...
	arguments() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << SintesisParser.SingleLineComment) | (1 << SintesisParser.OpenBracket) | (1 << SintesisParser.OpenParen) | (1 << SintesisParser.PlusPlus) | (1 << SintesisParser.MinusMinus) | (1 << SintesisParser.Plus) | (1 << SintesisParser.Minus) | (1 << SintesisParser.BitNot) | (1 << SintesisParser.Not))) !== 0) || ((((_la - 57)) & ~0x1f) == 0 && ((1 << (_la - 57)) & ((1 << (SintesisParser.NullLiteral - 57)) | (1 << (SintesisParser.DecimalLiteral - 57)) | (1 << (SintesisParser.HexIntegerLiteral - 57)) | (1 << (SintesisParser.OctalIntegerLiteral - 57)) | (1 << (SintesisParser.OctalIntegerLiteral2 - 57)) | (1 << (SintesisParser.BinaryIntegerLiteral - 57)) | (1 << (SintesisParser.BooleanLiteral - 57)) | (1 << (SintesisParser.Vector - 57)) | (1 << (SintesisParser.NumberOf - 57)))) !== 0) || ((((_la - 92)) & ~0x1f) == 0 && ((1 << (_la - 92)) & ((1 << (SintesisParser.Attributes - 92)) | (1 << (SintesisParser.Methods - 92)) | (1 << (SintesisParser.Super - 92)) | (1 << (SintesisParser.Map - 92)) | (1 << (SintesisParser.Identifier - 92)) | (1 << (SintesisParser.StringLiteral - 92)))) !== 0)) {
	            this.state = 417;
	            this.expression(0);
	            this.state = 422;
	            this._errHandler.sync(this);
	...
	vectorLiteral() {
	    ...
	    this.enterRule(localctx, 50, SintesisParser.RULE_vectorLiteral);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 487;
	...
	formalParameterArg() {
	    ...
	    this.enterRule(localctx, 52, SintesisParser.RULE_formalParameterArg);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 500;
	...
	functionBody() {
	    ...
	    this.enterRule(localctx, 54, SintesisParser.RULE_functionBody);
	    try {
	        this.state = 507;
	        this._errHandler.sync(this);
	...
	assignmentOperator() {
	    ...
	    this.enterRule(localctx, 56, SintesisParser.RULE_assignmentOperator);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 509;
	...
	assignable() {
	    ...
	    this.enterRule(localctx, 58, SintesisParser.RULE_assignable);
	    try {
	        this.state = 517;
	        this._errHandler.sync(this);
	...
	reservedWord() {
	    ...
	    this.enterRule(localctx, 60, SintesisParser.RULE_reservedWord);
	    try {
	        this.state = 522;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	literal() {
	    ...
	    this.enterRule(localctx, 62, SintesisParser.RULE_literal);
	    try {
	        this.state = 529;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	booleanLiteral() {
	    ...
	    this.enterRule(localctx, 64, SintesisParser.RULE_booleanLiteral);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 531;
	        this.match(SintesisParser.BooleanLiteral);
	...
	stringLiteral() {
	    ...
	    this.enterRule(localctx, 66, SintesisParser.RULE_stringLiteral);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 533;
	...
	nullLiteral() {
	    ...
	    this.enterRule(localctx, 68, SintesisParser.RULE_nullLiteral);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 535;
	        this.match(SintesisParser.NullLiteral);
	...
	numericLiteral() {
	    ...
	    this.enterRule(localctx, 70, SintesisParser.RULE_numericLiteral);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 537;
	...
	identifierName() {
	    ...
	    this.enterRule(localctx, 72, SintesisParser.RULE_identifierName);
	    try {
	        this.state = 541;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	keyword() {
	    ...
	    this.enterRule(localctx, 74, SintesisParser.RULE_keyword);
	    try {
	        this.state = 551;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
...
SintesisParser.RULE_vectorLiteral = 25;
SintesisParser.RULE_formalParameterArg = 26;
SintesisParser.RULE_functionBody = 27;
SintesisParser.RULE_assignmentOperator = 28;
SintesisParser.RULE_assignable = 29;
SintesisParser.RULE_reservedWord = 30;
SintesisParser.RULE_literal = 31;
SintesisParser.RULE_booleanLiteral = 32;
SintesisParser.RULE_stringLiteral = 33;
SintesisParser.RULE_nullLiteral = 34;
SintesisParser.RULE_numericLiteral = 35;
SintesisParser.RULE_identifierName = 36;
SintesisParser.RULE_keyword = 37;
...
class MapDeclarationContext extends VarDeclarationContext {

    constructor(parser, ctx) {
        super(parser);
        this.id = null; // Token;
        this.arg = null; // ArgumentsContext;
        super.copyFrom(ctx);
    }
