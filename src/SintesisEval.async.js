...
import { variableCreate, executeListMethod, executeStringMethod } from "./internals/Factory.js";
...
export default class SintesisEval extends SintesisParserVisitor {
 ...
 async callToFunction(memoryref, ctxArgs) {
  ...
  // Visit a parse tree produced by SintesisParser#expMemberIndex.
    ...
    if (!memoryref || !memoryref.variable || (typeof memoryref.variable.value !== 'string' && !memoryref.variable.getMemberRef )
