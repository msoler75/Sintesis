...
OpenBracket: '[' {this.openBrace();};
CloseBracket: ']' {this.closeBrace();};
OpenParen: '(' {this.openBrace();};
CloseParen: ')' {this.closeBrace();};
...
// from https://github.com/antlr/grammars-v4/blob/master/python/python3/Python3Lexer.g4
...
NullLiteral: 'null' | 'nul' | 'nulo' | 'nullo' | 'void';
...
Step: 'step' | 'paso' | 'passo' | 'etape' | '\u00E9tape';
...
While: 'while' | 'mientras' | 'mentre' | 'tantque' | 'enquanto';
...
Times: 'times' | 'veces' | 'volte' | 'fois' | 'vezes';

Do: 'do' | 'hacer' | 'faire' | 'fazer' | 'agire';
...
Break: 'break' | 'salir' | 'sortir' | 'sair' | 'uscire';
...
Class_: 'class' | 'clase' | 'classe';

Instance: 'instance' | 'instancia' | 'istanza';
...
Extends: 'extends' | 'extiende' | 'extende' | 'herda';
...
Method: 'method' | 'metodo' | 'm\u00E9todo' | 'm\u00E9tode';
...
Get: 'get' | 'obtener' | 'obtenir' | 'ottenere' | 'obter';
...
Identifier:
	[a-zA-Z$_\u00E1\u00E9\u00ED\u00F3\u00FA\u00C1\u00C9\u00CD\u00D3\u00DA\u00E0\u00E8\u00EC\u00F2\u00F9\u00C0\u00C8\u00CC\u00D2\u00D9\u00F1\u00D1]
		[a-zA-Z$_\u00E1\u00E9\u00ED\u00F3\u00FA\u00C1\u00C9\u00CD\u00D3\u00DA\u00E0\u00E8\u00EC\u00F2\u00F9\u00C0\u00C8\u00CC\u00D2\u00D9\u00F1\u00D1\u00E7\u00C70-9]
		*;
